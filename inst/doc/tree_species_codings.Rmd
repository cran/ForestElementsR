...
exist in the master table. Let us have a view on the coding in compact
form:
...
If you plan to implement a new species coding, carefully check the [species 
...
code table are used. Note that no NAs at all are allowed in your code table.
...
codings for examples, e.g. the species_ids 8, 9, and 10 in the coding *tum_wwk_short*.
