...
# Which reflects the tree species coding used by the 2012 German
...
#' Other users please take the function \code{\link{fe_species_ger_nfi_2012}}
#' for creating an object of that class.
#'
#' @param x An appropriate \code{character} vector
#'
#' @return An object of class \code{fe_species_ger_nfi_2012}
#'
#' @export
#'
#' @examples
...
#' )
#'
new_fe_species_ger_nfi_2012 <- function(x = character()) {
  new_fe_species(x, "fe_species_ger_nfi_2012")
}
...
#'   \code{fe_species_ger_nfi_2012} class
#'
#' @export
#'
#' @examples
...
#'
is_fe_species_ger_nfi_2012 <- function(x) {
  inherits(x, "fe_species_ger_nfi_2012")
}
...
#' \code{fe_species_ger_nfi_2012} is printed, be it alone, be it as part of
#' another object (e.g. a tibble)
#'
#' @param x An object of type \code{fe_species_ger_nfi_2012}
#'
...
#'   is to request the choice with \code{options("fe_spec_lang")}. If this option
...
#' spec_ids
#'
format.fe_species_ger_nfi_2012 <- function(x,
...
#'
#' @param object Object of class \code{\link{fe_species_ger_nfi_2012}}
#'
...
#' spec_ids |> summary()
#'
summary.fe_species_ger_nfi_2012 <- function(object,
                                            spec_lang = options("fe_spec_lang")$fe_spec_lang,
                                            maxsum = 100L,
                                            ...) {
...
#'
#' Provide an abbreviated name for the class \code{fe_species_ger_nfi_2012} to
...
#' str(spec_ids)
#'
vec_ptype_abbr.fe_species_ger_nfi_2012 <- function(x, ...) {
  "gr_nfi_2012"
}
...
#' )
#'
validate_fe_species_ger_nfi_2012 <- function(x = character()) {
  stopifnot(is_fe_species_ger_nfi_2012(x)) # Check for class attribute
...
#' *fe_species_ger_nfi_2012* convention
#'
#' The *ger_nfi_2012* species coding is the species coding used by the German
...
#' )
#'
fe_species_ger_nfi_2012 <- function(x = character()) {
  x <- trimws(as.character(x), which = "both")
  x <- new_fe_species_ger_nfi_2012(x)
  validate_fe_species_ger_nfi_2012(x)
}


# A fe_species_ger_nfi_2012 should be ordered by its integer values, even if
# ordering by the output of format would suggest another order

#' @export
vec_proxy_order.fe_species_ger_nfi_2012 <- function(x, ...) {
  as.integer(vctrs::vec_data(x))
}


# Casting into fe_species_ger_nfi_2012

#' @export
vec_cast.fe_species_ger_nfi_2012.integer <-
  function(x, to, ...) {
    x <- as.character(x)
    fe_species_ger_nfi_2012(x)
  }

#' @export
vec_cast.fe_species_ger_nfi_2012.double <-
  function(x, to, ...) {
    x <- as.character(x)
    fe_species_ger_nfi_2012(x)
  }
...
#' @export
vec_cast.fe_species_ger_nfi_2012.character <-
  function(x, to, ...) {
    fe_species_ger_nfi_2012(x)
  }

#' @export
vec_cast.fe_species_ger_nfi_2012.fe_species_tum_wwk_short <-
  function(x, to, ...) {
    x_trans <- spec_id_cast_do_it(x, "tum_wwk_short", "ger_nfi_2012")
    fe_species_ger_nfi_2012(x_trans)
  }

#' @export
vec_cast.fe_species_ger_nfi_2012.fe_species_tum_wwk_long <-
  function(x, to, ...) {
    x_trans <- spec_id_cast_do_it(x, "tum_wwk_long", "ger_nfi_2012")
    fe_species_ger_nfi_2012(x_trans)
  }

#' @export
vec_cast.fe_species_ger_nfi_2012.fe_species_bavrn_state <-
  function(x, to, ...) {
    x_trans <- spec_id_cast_do_it(x, "bavrn_state", "ger_nfi_2012")
    fe_species_ger_nfi_2012(x_trans)
  }

#' @export
vec_cast.fe_species_ger_nfi_2012.fe_species_bavrn_state_short <-
  function(x, to, ...) {
    x_trans <- spec_id_cast_do_it(x, "bavrn_state_short", "ger_nfi_2012")
    fe_species_ger_nfi_2012(x_trans)
  }

#' @export
vec_cast.fe_species_ger_nfi_2012.fe_species_master <-
  function(x, to, ...) {
    x_trans <- spec_id_cast_do_it(x, "master", "ger_nfi_2012")
    fe_species_ger_nfi_2012(x_trans)
  }
